...
(function (root) {
  ...
  var VILLAGERS = [
    V("Marlow", "Fisherman", "Weathered, unhurried, secretly sentimental",
      ...
      [2, 19],
      { skin: 5, hairStyle: "Cropped", hairColor: 14, eyeShape: 3, eyeColor: 5, details: 1, beard: 4,
    ...
    V("Perpetua", "Postmistress", "Brisk, nosy, fiercely loyal",
      ...
      [9, 3],
      { skin: 2, hairStyle: "Low bun", hairColor: 5, eyeShape: 5, eyeColor: 0, details: 0,
    ...
    V("Oyelaran", "Carpenter", "Precise, patient, talks through his hands",
      ...
      [6, 30],
      { skin: 11, hairStyle: "Buzzed", hairColor: 0, eyeShape: 2, eyeColor: 1, details: 0, beard: 3,
    ...
    V("Ilse", "Baker", "Warm, blunt, up before everyone",
      ...
      [11, 12],
      { skin: 1, hairStyle: "High bun", hairColor: 11, eyeShape: 1, eyeColor: 6, details: 3,
    ...
    V("Teodor", "Museum curator", "Delighted by everything, terrible at small talk",
      ...
      [4, 8],
      { skin: 3, hairStyle: "Tousled", hairColor: 13, eyeShape: 4, eyeColor: 2, details: 0, beard: 5,
    ...
    V("Nkechi", "Gardener", "Calm, observant, always half-covered in soil",
      ...
      [5, 21],
      { skin: 10, hairStyle: "Afro", hairColor: 2, eyeShape: 0, eyeColor: 0, details: 0,
    ...
    V("Bram", "Shopkeeper", "Cheerful, incorrigible, always selling",
      ...
      [1, 27],
      { skin: 4, hairStyle: "Side part", hairColor: 8, eyeShape: 7, eyeColor: 3, details: 1, beard: 2,
    ...
    V("Saoirse", "Lighthouse keeper", "Solitary, dry, good in a crisis",
      ...
      [10, 30],
      { skin: 0, hairStyle: "Long", hairColor: 9, eyeShape: 2, eyeColor: 4, details: 1,
    ...
    V("Idris", "Doctor", "Gentle, exacting, worries about everyone",
      ...
      [8, 14],
      { skin: 8, hairStyle: "Cropped", hairColor: 1, eyeShape: 1, eyeColor: 1, details: 0, beard: 3,
    ...
    V("Hana", "Potter", "Quiet, funny once she trusts you, ruthless about her own work",
      ...
      [3, 7],
      { skin: 2, hairStyle: "Bob", hairColor: 0, eyeShape: 2, eyeColor: 1, details: 0,
    ...
    V("Ambrose", "Beekeeper", "Slow-speaking, wry, entirely unbothered",
      ...
      [7, 2],
      { skin: 6, hairStyle: "Locs", hairColor: 3, eyeShape: 3, eyeColor: 9, details: 0, beard: 1,
    ...
    V("Elodie", "Tailor", "Theatrical, generous, a menace about your hemline",
      ...
      [12, 5],
      { skin: 3, hairStyle: "Waves", hairColor: 19, eyeShape: 5, eyeColor: 8, details: 2,
    ...
    V("Tomas", "Ferryman", "Taciturn, dependable, knows everyone's business",
      ...
      [2, 4],
      { skin: 7, hairStyle: "Undercut", hairColor: 4, eyeShape: 6, eyeColor: 0, details: 0, beard: 1,
    ...
    V("Marguerite", "Schoolteacher", "Endlessly patient, quietly mischievous",
      ...
      [9, 22],
      { skin: 1, hairStyle: "Low bun", hairColor: 15, eyeShape: 1, eyeColor: 2, details: 1,
    ...
    V("Kofi", "Cook", "Loud, competitive, softest man on the island",
      ...
      [6, 11],
      { skin: 12, hairStyle: "Buzzed", hairColor: 0, eyeShape: 4, eyeColor: 1, details: 0, beard: 1,
    ...
    V("Wren", "Herbalist", "Dreamy, precise about plants and nothing else",
      ...
      [4, 29],
      { skin: 0, hairStyle: "Braids", hairColor: 16, eyeShape: 0, eyeColor: 4, details: 3,
    ...
    V("Gideon", "Blacksmith", "Gruff, meticulous, secretly reads poetry",
      ...
      [1, 9],
      { skin: 9, hairStyle: "Shaved", hairColor: 0, eyeShape: 6, eyeColor: 1, details: 0, beard: 4,
    ...
    V("Liesel", "Painter", "Distracted, opinionated, generous with praise",
      ...
      [5, 3],
      { skin: 2, hairStyle: "High bun", hairColor: 6, eyeShape: 7, eyeColor: 6, details: 1,
    ...
    V("Rasheed", "Diver", "Fearless, teasing, allergic to sitting down",
      ...
      [7, 26],
      { skin: 8, hairStyle: "Curls", hairColor: 2, eyeShape: 4, eyeColor: 0, details: 0, beard: 1,
    ...
    V("Beatrix", "Archivist", "Whispery, exact, delighted by paperwork",
      ...
      [11, 1],
      { skin: 1, hairStyle: "Low bun", hairColor: 12, eyeShape: 3, eyeColor: 7, details: 0,
    ...
    V("Callum", "Farmer", "Plain-spoken, early to bed, never once hurried",
      ...
      [3, 18],
      { skin: 3, hairStyle: "Cropped", hairColor: 10, eyeShape: 0, eyeColor: 5, details: 1, beard: 1,
    ...
    V("Amara", "Weaver", "Watchful, kind, says less than she knows",
      ...
      [10, 7],
      { skin: 13, hairStyle: "Braids", hairColor: 0, eyeShape: 2, eyeColor: 1, details: 0,
    ...
    V("Stefan", "Brewer", "Grandiose, warm, wildly unreliable about time",
      ...
      [8, 30],
      { skin: 4, hairStyle: "Tousled", hairColor: 7, eyeShape: 7, eyeColor: 3, details: 1, beard: 5,
    ...
    V("Junko", "Musician", "Nocturnal, teasing, plays through conversations",
      ...
      [12, 21],
      { skin: 2, hairStyle: "Ponytail", hairColor: 17, eyeShape: 5, eyeColor: 8, details: 0,
